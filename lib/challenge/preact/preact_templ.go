...
func page(redir, challenge string, difficulty int, loc *localization.SimpleLocalizer, mascotSet string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `preact.templ`, Line: 11, Col: 184}
		}
		...
		templ_7745c5c3_Err = templ.JSONScript("preact_info", map[string]any{
			...
			"pensive_url":                 anubis.BasePrefix + "/.within.website/x/cmd/anubis/static/img/" + mascotSet + "/pensive.webp?cacheBuster=" + anubis.Version,
